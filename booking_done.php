...
<body>
    ...
    <section class="product_done">
        <div class="container product_done_bg">
            <div class="row">
                <div class="col-lg-6 offset-lg-1">
                    <div class="product_done_wrap">
                        <div class="product_done_content">
                            <div class="product_done_heading">
                            ...
                            <div class="restaurant_details_header">
                                ...
                                <div class="restaurant_review_content">
                                    ...
                                    <div class="restaurant_order">
                                        <ul>
                                            <li><span><i class="fas fa-calendar-minus"></i></span> Wed,Jan 22</li>
                                            <li><span><i class="far fa-clock"></i></span>6:00 pm</li>
                                            <li><span><i class="fa fa-user"></i></span>2 person</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="product_reservation">
                            <p><a href="" data-toggle="modal" data-target="#signInModal">Sign in</a> or <a href="" data-toggle="modal" data-target="#signUpModal">Sign up</a> to collect points for this reservation</p>
                            <form>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control w-100" placeholder="Phone Number">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="email" class="form-control w-100" placeholder="Email">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <textarea name="" rows="5" cols="15" class="form-control w-100" placeholder="Add a Special request (Optional)"></textarea>
                                    </div>
                                </div>
                                <button type="submit" class="btn1  btn-block mt-30">Complete Reservation</button>
                            </form>
                            <div class="restaurant_policy mt-30">
                                <p>By clicking “Complete reservation” you agree to the <a href="">The Ruby Restaurant Terms of
                                        Use</a> and <a href="">Privacy Policy</a>. Standard text message rates may apply. You may opt out of
                                    receiving text messages at any time.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="booking_aside">
                        <h4>What to know before you go</h4>
                        <div class="booking_aside_content">
                            <h5>Important dining information</h5>
                            <article>
                                <p>
                                    We have a 15 minute grace period. Please call us if you are running later than 15 minutes after your booked time.</p>
                            </article>
                        </div>
                        <div class="booking_aside_content">
